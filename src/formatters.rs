...
pub fn compress_sets(sets: &Vec<Set>) -> Vec<String> {
...
pub fn format_workout(jday: &JDay) -> String {
    let mut ex_map: HashMap<String, &crate::models::Exercise> = HashMap::new();
...
pub fn format_full_workout(jday: &JDay, ymd: &str) -> String {
